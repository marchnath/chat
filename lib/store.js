  ...
  persist(
        ...
        try {
          ...
          if (profileSettings) {
            ...
            set({
              ...
              avatarUrl: settings.avatarUrl || DEFAULT_PROFILE.avatarUrl,
              displayName: settings.displayName || DEFAULT_PROFILE.displayName,
              streakDays: settings.streakDays || DEFAULT_PROFILE.streakDays,
            });
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        // Don't persist word translation menu state
      }),
    }
  )
);
